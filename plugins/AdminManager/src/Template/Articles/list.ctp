...
<?= $this->Html->script('AdminManager.articlesCategory.js', ['inline' => 'false']) ?>
...
<div class="row">
	<div class="columns large-12">
		...
		<table>
			...
			<tr id="id-<?= $article->id ?>">
				<td>
					<?= $this->Html->link($article->id, [ 'controller' => 'ArticlesCategory', 'action' => 'edit', '_method' => 'GET', 'plugin' => 'AdminManager', $article->id]) ?>
				</td>
				<td>
					<?= $this->Html->link($article->title_vi, [ 'controller' => 'ArticlesCategory', 'action' => 'edit', '_method' => 'GET', 'plugin' => 'AdminManager', $article->id]) ?>
				</td>
				<td>
					<?= $this->Html->link($article->title_jp, [ 'controller' => 'ArticlesCategory', 'action' => 'edit', '_method' => 'GET', 'plugin' => 'AdminManager', $article->id]) ?>
				</td>
				<td>
