(function() {
    ...
    function() {
        ...
        angular.module("app.ui.form.ctrls", []).controller("TagsDemoCtrl", ["$scope", function($scope) {
            ...
            return $scope.today = function() {
                return $scope.news_info.date_active = new Date
            }, $scope.today(), $scope.showWeeks = !0, $scope.toggleWeeks = function() {
                return $scope.showWeeks = !$scope.showWeeks
            }, $scope.clear = function() {
                return $scope.news_info.date_active = null
                ...
                "year-format": "'yy'",
                "starting-day": 1
            }, $scope.formats = ["dd-MM-yyyy", "dd-MMMM-yyyy", "yyyy/MM/dd", "shortDate"], $scope.format = $scope.formats[0]
    ...
    function() {
        ...
        angular.module("app.form.validation", []).controller("wizardFormCtrl", ["$scope", function($scope) {
        ...
        }]).controller("addNewsCategoryCtrl", ["$scope", function($scope) {
            var original;
            ...
            return $scope.category = {
                ...
                title_jp: "",
                description_jp: ""
            }, $scope.showInfoOnSubmit = !1, original = angular.copy($scope.category), $scope.revert = function() {
                return $scope.category = angular.copy(original), $scope.form_news_category.$setPristine()
            }, $scope.canRevert = function() {
                return !angular.equals($scope.category, original) || !$scope.form_news_category.$pristine
            }, $scope.canSubmit = function() {
                return $scope.form_news_category.$valid && !angular.equals($scope.category, original)
            }, $scope.submitForm = function() {
                return $scope.showInfoOnSubmit = !0
            }
        }]).controller("addNewsCtrl", ["$scope", function($scope) {
            var original;

            return $scope.news_info = {
                top_flag: 0,
                title_vi: "",
                body_vi: "",
                keyword_vi: "",
                ...
                date_active_hour: "",
                date_active_minute: ""
            }, $scope.showInfoOnSubmit = !1, original = angular.copy($scope.news_info), $scope.revert = function() {
                return $scope.news_info = angular.copy(original), $scope.form_news.$setPristine()
            }, $scope.canRevert = function() {
                return !angular.equals($scope.news_info, original) || !$scope.form_news.$pristine
            }, $scope.canSubmit = function() {
                return $scope.form_news.$valid && !angular.equals($scope.news_info, original)
            }, $scope.submitForm = function() {
                return $scope.showInfoOnSubmit = !0
            }
        }])
    ...
    function() {
        ...
        angular.module("app.localization", []).factory("localize", ["$http", "$rootScope", "$window", function($http, $rootScope, $window) {
            ...
            return $scope.lang = "Vietnamese", $scope.setLang = function(lang) {
                switch (lang) {
                    case "English":
